...
if [[ "$OSTYPE" == "darwin"* ]]; then
    ...
    alias pacu='brew update && brew upgrade && brew cleanup && brew cask cleanup && fresh update && vi -c PlugUpdate -c quitall'
    ...
    alias pacu='packer -Syu && fresh update && vi -c PlugUpdate -c quitall'
fi
