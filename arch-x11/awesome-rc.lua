...
-- {{{ Tags
tags = {
   names = { "web", "media", "dev", "docs", "etc", "music" },
   layout = { layouts[2], layouts[1], layouts[2], layouts[2], layouts[2], layouts[2] }
}
...
mytextclock = awful.widget.textclock(markup("#7788af", "%b %d ") .. markup("#343639", ">") .. markup("#de5e1e", " %H:%M:%S "), 1)
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ altkey,           }, "f",      function () fswidget.show(7) end),
    ...
    -- Copy to clipboard
    awful.key({ altkey }, "c", function () os.execute("xsel -p -o | xsel -i -b") end),
    ...
    awful.key({ modkey, "Control" }, "c", function () awful.util.spawn("chromium --incognito") end),
    awful.key({ modkey }, "e", function () awful.util.spawn("nautilus") end),
    awful.key({ modkey }, "a", function () awful.util.spawn(mail) end),
